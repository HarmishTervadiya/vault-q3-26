...
fn test() {
    ...
    send(
        ...
        Instruction::new_with_bytes(
            program_id,
            &week2_vault::instruction::Initialize {}.data(),
            week2_vault::accounts::Initialize {
                user: user.pubkey(),
                vault_state,
                vault,
    ...
    send(
        ...
        Instruction::new_with_bytes(
            program_id,
            &week2_vault::instruction::Deposit {
                amount: DEPOSIT_LAMPORTS,
            }
            .data(),
            week2_vault::accounts::Deposit {
                user: user.pubkey(),
                vault_state,
                vault,
                system_program: system_program::ID,
    ...
    //     Instruction::new_with_bytes(
    //         program_id,
    //         &week2_vault::instruction::Withdraw {
    //             amount: WITHDRAW_LAMPORTS,
    //         }
    //         .data(),
    //         week2_vault::accounts::Withdraw {
    //             user: user.pubkey(),
    //             vault_state,
    //             vault,
    //             system_program: system_program::ID,
    ...
    //     Instruction::new_with_bytes(
    //         program_id,
    //         &week2_vault::instruction::Close {}.data(),
    //         week2_vault::accounts::Close {
    //             user: user.pubkey(),
    //             vault_state,
    //             vault,
    //             system_program: system_program::ID,
